...
git clone https://github.com/sbwml/autocore-arm --depth=1 --branch openwrt-24.10 clone/autocore
...
cp -rf clone/autocore-arm package/autocore/
...
cp -rf clone/passwall-packages/[a-z]* feeds/packages/net/
